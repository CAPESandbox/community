rule DanaBot {
    ...
    strings:
        ...
        //$o1 = { e9 48 01 00 00 80 bc 24 4a 01 00 00 01 75 14 ba }
        //$o2 = { 55 8b ec 33 c0 55 68 d7 60 4f 00 64 ff 30 64 89 }
        //$o3 = { e8 45 ec f0 ff e8 3c e2 f0 ff 68 00 04 00 00 e8 }
    condition:
